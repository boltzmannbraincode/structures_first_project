...
for l in range(10):
    ...
    for k in range(10):  # write 10 buffers to each of the 10 files
        ...
        disk_acess_counter = disk_acess_counter + 1
    print("created new " + filename )
    sorted_file.close()
print("Done.")

print("Acessed the disk a total of " + str(disk_acess_counter) + " times.")
